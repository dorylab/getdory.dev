...
Si no necesitas Web UI, usa [Headless Runtime](/es/docs/agents/cli-headless) en lugar de desplegar toda la aplicación Web.
...
| --- | --- | --- |
| Base de datos de la aplicación | Usuarios, organizaciones, conexiones, consultas guardadas, configuraciones y tokens MCP de Dory. | [Variables de entorno](/es/docs/deploy/environment-variables) |
...
- [Variables de entorno](/es/docs/deploy/environment-variables)
