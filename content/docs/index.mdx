...
1. Start with [Quick Start](/docs/getting-started/quick-start).
2. Read [Connect Your Database](/docs/getting-started/connect-your-database).
3. Learn [SQL Console](/docs/core-features/sql-console) and [AI Chat](/docs/core-features/ai-chat).
4. Review [Deployment](/docs/deploy) before rolling Dory out to a team.
...
See [Release Notes](/docs/release-notes) for recent product changes and documented capabilities.
