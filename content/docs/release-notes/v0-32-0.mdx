...
![Dory v0.32.0 routes large SQL result sets through DuckDB into Parquet-backed, smoothly browsable data](/images/blog/dory-v0-32-0-no-limit-sql-cover-en.png)
