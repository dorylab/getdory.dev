...
![Dory v0.32.0 routes large SQL result sets through DuckDB into Parquet-backed, smoothly browsable data](https://github.com/user-attachments/assets/a6f51711-395f-4065-b66d-1d1bbf310369)
