---
title: v0.3.11
description: Dory release notes for v0.3.11.
---

# v0.3.11

[View source on GitHub](https://github.com/dorylab/dory/blob/main/release-notes/v0.3.11.md)
...
- **Yarn upgrade to v4**: Migrated the entire monorepo from Yarn v1 to Yarn v4, including:
  ...
  - Renamed root workspace to `dory-monorepo` to resolve naming conflicts with desktop
