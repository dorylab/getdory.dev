...
1. 打开 [Connections](../core-features/connections)。
2. 选择 ClickHouse。
...
使用 [Monitoring](../core-features/monitoring) 可以查看：
...
使用 [Privileges](../core-features/privileges) 可以管理：
...
- [Monitoring](../core-features/monitoring)
- [Privileges](../core-features/privileges)
