...
Dory documentation covers ClickHouse, PostgreSQL, Neon, MySQL, MariaDB, SQLite, DuckDB, MotherDuck, and other hosted databases that expose compatible connection endpoints. See [Database Support](/docs/database-support) for driver-specific guidance.
...
Start with the provider already approved by your organization. If you need a standard path, use OpenAI. If your organization uses a compatible endpoint, use OpenAI-compatible. See [AI Providers](/docs/reference/ai-providers).
