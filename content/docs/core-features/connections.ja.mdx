...
| タイプ | 一般的な使用方法 |
| --- | --- |
| ClickHouse | 分析、イベント、監視、運用データ |
| PostgreSQL / Neon / Supabase | 製品、アプリケーション、Serverless PostgreSQL |
| MySQL / MariaDB | 業務システムと Web アプリケーション |
| SQL Server | エンタープライズ アプリ、レポート、運用システム |
| Oracle | ERP、財務、エンタープライズ システム、長期運用データ |
| Snowflake | Cloud analytics、レポート、共有データ platform |
| Cloudflare D1 | Cloudflare API 経由の Serverless SQLite |
| SQLite | ローカル ファイル、デモ、および小規模なデータセット |
| DuckDB / MotherDuck | ローカル分析とファイルベースの分析 |
