...
| PostgreSQL / Neon / Supabase | Product, application, and serverless PostgreSQL databases |
...
| Snowflake | Cloud analytics, reporting, and shared data platforms |
| Cloudflare D1 | Serverless SQLite through the Cloudflare API |
