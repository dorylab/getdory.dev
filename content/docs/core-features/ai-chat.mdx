...
AI Chat is an in-product assistant. It is different from an external agent connected through MCP: external agents create Agent Runs and can preserve SQL, result snapshots, findings, and steps for human handoff. See [Agent Workspaces](/en/docs/agents) for that workflow.
...
Continue with [Generate SQL with Ask AI](/en/docs/workflows/generate-sql-with-ai) or [SQL Console](/en/docs/core-features/sql-console).
