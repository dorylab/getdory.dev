...
If you do not know the right table yet, start with [Explore Unknown Tables](./explore-unknown-tables).
...
- Debug performance with [Debug Slow Queries](./debug-slow-queries).
- Build visuals with [Build Charts from SQL](./build-charts-from-sql).
- Save stable work with [Save & Reuse Analysis](./save-reuse-analysis).
