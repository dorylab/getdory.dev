...
- Generate queries with [Generate SQL with AI](./generate-sql-with-ai).
- Shape chart output with [Build Charts from SQL](./build-charts-from-sql).
- Learn feature details in [Saved Queries](../core-features/saved-queries).
