...
For ClickHouse, start with [Monitoring](../core-features/monitoring):
...
- Rewrite with [Generate SQL with AI](./generate-sql-with-ai).
- Build visuals with [Build Charts from SQL](./build-charts-from-sql).
- Save proven queries in [Saved Queries](../core-features/saved-queries).
