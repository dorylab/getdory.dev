...
切换到 [Charts & Results](../core-features/charts-results) 后检查：
...
- 如果还没有 SQL，先看 [Generate SQL with AI](./generate-sql-with-ai)。
- 如果查询慢，先看 [Debug Slow Queries](./debug-slow-queries)。
- 图表对应的 SQL 稳定后，保存到 [Saved Queries](../core-features/saved-queries)。
