...
- 从 [Generate SQL with AI](./generate-sql-with-ai) 生成查询。
- 用 [Build Charts from SQL](./build-charts-from-sql) 整理图表输出。
- 查看 [Saved Queries](../core-features/saved-queries) 了解功能细节。
