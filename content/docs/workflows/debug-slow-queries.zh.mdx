...
如果使用 ClickHouse，先打开 [Monitoring](../core-features/monitoring)：
...
- 如果 SQL 需要重写，使用 [Generate SQL with AI](./generate-sql-with-ai)。
- 如果结果稳定，使用 [Build Charts from SQL](./build-charts-from-sql)。
- 把优化后的排查 SQL 保存到 [Saved Queries](../core-features/saved-queries)。
