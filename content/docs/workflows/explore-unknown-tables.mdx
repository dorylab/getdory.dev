...
Open [Explorer](../core-features/explorer) and confirm that databases, schemas, tables, and views load correctly.
...
- Generate a first business query with [Generate SQL with AI](./generate-sql-with-ai).
- Run and validate it in [SQL Console](../core-features/sql-console).
- Build visuals with [Build Charts from SQL](./build-charts-from-sql).
