  ...
  return (
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          "origin-top-center bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 border-border/80 dark:border-border/60 relative mt-3 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-[24px] border shadow-[0_18px_45px_rgba(15,23,42,0.12)] md:w-[var(--radix-navigation-menu-viewport-width)] dark:shadow-[0_18px_48px_rgba(2,6,23,0.45)]",
          className,
        )}
        {...props}
      />
